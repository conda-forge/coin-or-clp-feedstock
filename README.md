...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/coin-or-clp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/coin-or-clp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add coin-or-clp
# for installing globally
pixi global install coin-or-clp
```
...
It is possible to list all of the versions of `coin-or-clp` available on your platform:
...
```
pixi search coin-or-clp --channel conda-forge
```
